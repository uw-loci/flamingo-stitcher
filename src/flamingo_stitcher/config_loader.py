...
Usage::
    ...
    from flamingo_stitcher.config_loader import get_hardware_config, get_stitching_defaults
...
def apply_stitching_yaml_to_config(config_obj: Any) -> None:
    ...
    if reg.get("z_content_crop") is not None:
        config_obj.registration_z_content_crop = bool(reg["z_content_crop"])
    ...
    if reg.get("verbose_alignment_log") is not None:
        config_obj.verbose_alignment_log = bool(reg["verbose_alignment_log"])
